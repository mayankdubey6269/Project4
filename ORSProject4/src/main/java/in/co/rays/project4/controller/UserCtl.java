    ...
    if (OP_SAVE.equalsIgnoreCase(op) || (OP_UPDATE.equalsIgnoreCase(op))) {
        ...
        try {
            if (id > 0) {
            	...
            	model.update(bean);
                   ServletUtility.setBean(bean, request);
                   ServletUtility.setSuccessMessage("Data is successfully Update",
                           request);
       ...
       // 	   log.error(e);
            ...
            return;
				 ...
				 * catch ( DuplicateRecordException e) { ServletUtility.setBean(bean, request);
        ...
        ServletUtility
                .redirect(ORSView.USER_LIST_CTL, request, response);
        return;
