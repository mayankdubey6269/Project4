...
<table>	
	<tr><th class="p1">Email Id <span style="color:red;">*</span></th>&emsp;
	...
	&emsp;
	 -->
	<tr><th style="padding: 3px"><!-- <th></th> -->
	<!-- &emsp;
	&emsp; -->
	 <td><input type="submit" name="operation" value="<%=ForgetPasswordCtl.OP_GO %>"style="padding: 3px;">
	 <input type="submit" name="operation" value="<%=ForgetPasswordCtl.OP_RESET %>"style="padding: 3px;"><br></font></td>
	<%-- <td style="position:fixed;padding-top:10px;"><font color="red">
	<%=ServletUtility.getErrorMessage("login", request) %></font>
	</td> --%></tr>
	</table>
